...
# API Configuration
API_ID = int(os.environ.get("API_ID", "35276439"))
API_HASH = os.environ.get("API_HASH", "e99cd1e3ee622ebc7ca6f4ad9a14faa3")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")

CREDIT = os.environ.get("CREDIT", "dik𝐔")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "940057661"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "940057661").split()]  # Default to owner ID
